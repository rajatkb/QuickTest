...
function makeFormSubmission(){
    ...
    var newTestTemplate = '<div class="test-list-item test-submitted" id="test' + (testCount.length+1) + '"><div class="test-title"><h5  id="title-test' + index + '">' + newTestData.testData.title + '</h5></div><div class="test-info"><p id="desc-test' + index + '">' + newTestData.testData.desc + '</p><span class="test-info-labels">Scheduled date of examination: </span><span id="date-test' + index + '>' + newTestData.testData.date + '</span> <br><span class="test-info-labels">Department: </span><span id="dept-test' + index + '">' + newTestData.testData.dept + '</span> <br><span class="test-info-labels">Batch: </span><span> ' + 20+newTestData.testData.batch + '</span> <br><span class="test-info-labels">Maximum marks: </span><span id="marks-test' + index + '">' + newTestData.testData.fullMarks + '</span> <br></div><div class="controls"><button class="start-test"><button class="delete-test"><i class="fa fa-trash-o"></i>Delete</button></div></div>';
