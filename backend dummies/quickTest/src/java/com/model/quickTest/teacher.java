...
public class teacher {
    ...
    */
    ...
    public int createDB(Connection dbObj) //CREATES DATABASE FOR FIRST TIME
    {
         try{
    ...
    public int deleteDataFromDB(Connection dbObj)
    {   
        try
        {
            Statement stateObj = (Statement) dbObj.createStatement();
    ...
    public int loadDataFromDb(Connection dbObj , int teacherId)
    {
        try
        {
            Statement stateObj = (Statement) dbObj.createStatement();
